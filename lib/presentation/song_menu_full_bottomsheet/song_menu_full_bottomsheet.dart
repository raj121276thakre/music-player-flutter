...
class SongMenuFullBottomsheet extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SongMenuFullBloc>(
      create: (context) => SongMenuFullBloc(SongMenuFullState(
        songMenuFullModelObj: SongMenuFullModel(),
      ))
  ...
  Widget _buildOptions(BuildContext context) {
    return Expanded(
      child:
          BlocSelector<SongMenuFullBloc, SongMenuFullState, SongMenuFullModel?>(
